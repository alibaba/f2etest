...
start /MAX "" "C:\Program Files (x86)\Microsoft Office\Office15\POWERPNT.EXE"
set isWeb=1
if "%1" equ "" (
	set isWeb=0
)
start "" curl "http://f2etest.xxxx.com/applog?userid=%USERNAME%&appid=powerpoint&isweb=%isWeb%"