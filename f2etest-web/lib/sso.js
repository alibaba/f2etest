...
// 需要强制登录的URL
var reRequireLoginUrl = /^\/($|initUser|openapp|help|install|stat|statteam|statuser|changelog|api|local|install\.bat|getAllBrowsers|webdriver|wd_api|wd_stat|wd_nodejs|jsunit|jsunit_nodejs|jsunit_browser|jsunit_api|autotest|karma\.conf\.js)/;
