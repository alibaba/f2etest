...
start /MAX "" "C:\Program Files (x86)\UCBrowser\Application\UCBrowser.exe" %url%
set isWeb=1
if "%1" equ "" (
	set isWeb=0
)
start "" curl "http://f2etest.xxxx.com/applog?userid=%USERNAME%&appid=ucbrowser&isweb=%isWeb%"